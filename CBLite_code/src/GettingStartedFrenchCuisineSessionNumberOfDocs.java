...
public class GettingStartedFrenchCuisineSessionNumberOfDocs {

	private static final int numberOfDocs = 1;
	...
	public static void main(String[] args) throws CouchbaseLiteException, InterruptedException, URISyntaxException {
		...
		if (writeNewDocument) {
			...
			MutableDocument mutableDoc = new MutableDocument("produit_from_CBL_NEW6_" + i)
